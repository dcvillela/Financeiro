...
import edu.fema.financeiro.model.Lancamento;
import edu.fema.financeiro.model.Pessoa;
import edu.fema.financeiro.model.TipoLancamento;
import edu.fema.financeiro.util.JpaUtil;

public class CriaLancamentos {

	public static void main(String[] args) {
		// Cria lançamentos iniciais do projeto
